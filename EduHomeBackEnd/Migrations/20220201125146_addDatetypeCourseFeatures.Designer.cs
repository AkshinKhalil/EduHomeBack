...
namespace EduHomeBackEnd.Migrations
{
    ...
    [Migration("20220201125146_addDatetypeCourseFeatures")]
    partial class addDatetypeCourseFeatures
    {
            ...
            modelBuilder.Entity("EduHomeBackEnd.Models.Course", b =>
                {
                    ...
                    b.HasOne("EduHomeBackEnd.Models.CourseFeatures", "CourseFeatures")
                        .WithOne("Course")
                        .HasForeignKey("EduHomeBackEnd.Models.Course", "CourseFeaturesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
