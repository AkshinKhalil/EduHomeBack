...
namespace EduHomeBackEnd.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterVM register)
        {
            ...
            if (!register.Terms)
            {
                ModelState.AddModelError("Terms", "Please check this field to scan you");
                return View();
            }
            ...
            mail.From = new MailAddress("alialiyevasmoy@gmail.com", "EduHome company");
        ...
        public async Task<IActionResult> ForgotPassword(AccountVM account)
        {
            ...
            MailMessage mail = new MailMessage();
            mail.From = new MailAddress("aksinxelilovcodeeduaze@gmail.com", "EduHome");
            mail.To.Add(new MailAddress(user.Email));
            ...
            smtp.Credentials = new NetworkCredential("aksinxelilovcodeeduaze@gmail.com", "codeeduaze223");
            smtp.Send(mail);
            return RedirectToAction("index", "home");
        }
